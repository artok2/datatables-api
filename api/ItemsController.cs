...
using  Datatables.Api.api;

// For more information on enabling Web API for empty projects, visit http://go.microsoft.com/fwlink/?LinkID=397860

namespace Datatables.Api.Controllers.api
{
    ...
    public class ItemsController : BaseController
    {
        // POST api/values
        [HttpPost]
        public IActionResult Post(Models.SearchRequest  request)
        {    
            List<Models.Item> lstItems = GetData();            
            var response = GetResponse(lstItems, request);
            return Ok(response);
